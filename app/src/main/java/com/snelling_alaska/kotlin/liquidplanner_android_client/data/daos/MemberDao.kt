...
typealias MembersCb = (List<Member>?) -> Unit

object MemberDao {
  fun loadMembers(workspaceId: Int, then: MembersCb) {
    val url = Api.shared.urlBuilder("workspaces/${workspaceId}/members")
      .addQueryParameter("include_disconnected", "true")
  ...
  fun loadMembers(workspace: Workspace, then: MembersCb)
    = loadMembers(workspace.id, then)
}
